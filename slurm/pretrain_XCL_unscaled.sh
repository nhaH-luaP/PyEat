...
#SBATCH --output=/mnt/stud/work/phahn/repositories/EAT/logs/pretrain_XCL_unscaled.log
...
OUTPUT_DIR=/mnt/stud/work/phahn/repositories/EAT/output/pretrain/unscaled/
